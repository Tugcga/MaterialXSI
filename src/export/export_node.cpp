...
MaterialX::NodePtr shader_to_node(const XSI::Shader& xsi_shader,
	...
	XSI::CString xsi_name = export_options.use_unique_names ? replace_letter(replace_letter(xsi_shader.GetUniqueName(), '<', '_'), '>', '_') : xsi_shader.GetName();
...
MaterialX::NodeGraphPtr compound_to_graph(const XSI::Shader& xsi_compound,
	...
	XSI::CString xsi_name = export_options.use_unique_names ? replace_letter(replace_letter(xsi_compound.GetUniqueName(), '<', '_'), '>', '_') : xsi_compound.GetName();
